...
COUCHBASE_VERSIONS = ["0.0.0",
                      ...
                      "6.0.3", "6.0.4", "6.5.0", "6.5.1", "6.6.0", "7.0.0", temp_DP_magma]
CB_RELEASE_BUILDS = {"0.0.0":"0000",
                     ...
                     "6.5.0":"4967", "6.5.1":"0000", "6.6.0":"0000", "7.0.0":"0000", temp_DP_magma:"0000"}
COUCHBASE_FROM_VERSION_3 = ["3.0.0", "3.0.1", "3.0.2", "3.0.3", "3.1.0", "3.1.1",
                            ...
                            "6.0.2", "6.0.3", "6.0.4", "6.5.0", "6.5.1", "6.6.0", "7.0.0", temp_DP_magma]
...
COUCHBASE_FROM_WATSON = ["0.0.0",
                         ...
                         "6.5.0", "6.5.1", "6.6.0", "7.0.0", temp_DP_magma]
"""
...
COUCHBASE_FROM_VULCAN = ["0.0.0", "5.5.0", "5.5.1", "5.5.2", "5.5.3", "5.5.4", "5.5.5",
                        ...
                        "6.5.1", "6.6.0", "7.0.0", temp_DP_magma]
COUCHBASE_FROM_ALICE = ["0.0.0", "6.0.0", "6.0.1", "6.0.2", "6.0.3", "6.0.4", "6.5.0", "6.6.0", "7.0.0", temp_DP_magma]
COUCHBASE_FROM_601 = ["0.0.0", "6.0.1", "6.0.2", "6.0.3", "6.0.4", "6.5.0", "6.5.1", "6.6.0", "7.0.0", temp_DP_magma]
COUCHBASE_FROM_MAD_HATTER = ["0.0.0", "6.5.0", "6.6.0", "7.0.0", temp_DP_magma]
COUCHBASE_FROM_CHESHIRE_CAT = ["0.0.0", "7.0.0", temp_DP_magma]
...
SYSTEMD_SERVER = ["centos 8", "centos 7", "suse 12", "suse 15", "ubuntu 16.04", "ubuntu 18.04",
                  "ubuntu 20.04", "debian 8", "debian 9", "debian 10", "debian gnu/linux 8", "debian gnu/linux 9",
                  "rhel 8", "oel 7", "oel 8"]
